package com.muchbeer.king.sync;
...
import com.muchbeer.king.MainActivity;
import com.muchbeer.king.R;
import com.muchbeer.king.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            for (int i = 0; i < weatherArray.length(); i++) {
                ...
                weatherValues.put(WeatherContract2.WeatherEntry.COLUMN_DATETEXT, WeatherContract2.getDbDateString(new Date(dateTime * 1000L)));
            ...
            if (cVVector.size() > 0) {
                ...
                getContext().getContentResolver().bulkInsert(WeatherContract2.WeatherEntry.CONTENT_URI, cvArray);
                ...
                String yesterdayDate = WeatherContract2.getDbDateString(cal.getTime());
                getContext().getContentResolver().delete(WeatherContract2.WeatherEntry.CONTENT_URI,
    ...
    private long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if (locationCursor.moveToFirst()) {
            int locationIdIndex = locationCursor.getColumnIndex(WeatherContract2.LocationEntry._ID);
    ...
    private void notifyWeather() {
        ...
        if (displayNotifications) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                Uri weatherUri = WeatherContract2.WeatherEntry.buildWeatherLocationWithDate(locationQuery, WeatherContract2.getDbDateString(new Date()));
